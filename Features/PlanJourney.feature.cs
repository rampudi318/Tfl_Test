...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Plan a journey", "The widget is accessible from the TFL Homepage or by clicking the “Plan a journey" +
                    "” tab from the homepage.  ", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void AValidJourneyWillConsistOfAValidLocationsEnteredIntoTheWidgetPage()
        {
            string[] tagsOfScenario = new string[] {
                    "tag1"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("A valid journey will consist of a valid locations entered into the widget page", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
